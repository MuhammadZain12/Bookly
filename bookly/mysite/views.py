...
class RoomView(View):
  ...
  def get(self,request,*args,**kwargs):
    ...
    try:
      ...
      return render(request,'mysite/room.html',context={'room':context_object,'bookings':None})
    else:
      return render(request,'mysite/room.html',context={'room':context_object,'bookings':booking_data})     
  def get_queryset(self):
  ...
  def post(self,request,*args,**kwargs):
    ...
    booking=Booking(user=user,room=room,hotel=hotel,nights=request.POST['night'])
    print(booking)
...
#   model=User
#   context_object_name='user_account_infos'
